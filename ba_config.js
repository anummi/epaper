...
window.epaperConfig = {
  ...
  labels: {
    ...
    archiveLatestIssues: { fi: 'Viimeisimmät numerot', en: 'Latest issues' },
    archiveOlderIssues: { fi: 'Arkistonumerot', en: 'Archive issues' },
    ...
    pageIndicatorLabelSingle: { fi: 'Sivu', en: 'Page' },
    pageIndicatorLabelRange: { fi: 'Sivut', en: 'Pages' },
